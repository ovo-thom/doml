...
export default function AiMarketingSection() {
  return (
    <section className="text-white h-screen my-32">
      <div className="grid grid-cols-1 sm:grid sm:grid-cols-[60%_40%] justify-center items-center">
        <div className="w-full order-2 sm:order-1">
          ...
          <Image
            ...
            alt="optimized reach"
          />
          <p className=" text-lg w-[77%] mt-8">
            Our vision is to revolutionize the way brands and advertisers
            target, reach
          </p>
          <span className="block bg-gradient-to-r from-[#FF2DF7] via-[#5200FF] to-[#00F0FF] h-[1px] my-10 w-3/4"></span>
          <div className="bg-gradient-to-r from-[#FF2DF7] via-[#5200FF] to-[#00F0FF] p-[1px] rounded-2xl w-36">
            <div className="flex justify-center items-center bg-black rounded-2xl py-1">
        ...
        <div className="flex justify-center order-1 sm:order-2">
          <Image height={450} width={450} src={planet} alt="planet" className="max-w-[200px] w-full h-auto" />
        </div>
      </div>
    </section>
  );
